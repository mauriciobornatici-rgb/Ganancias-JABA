...
function Home() {
  ...
  // "clientes" ya no es vista interna: vive en /clientes (migración a rutas propias).
  // Parámetros y Auditoría se derivan de ?view=... hasta migrar a sus propias rutas.
  const viewParam = searchParams.get('view');
  const activeView: 'dashboard' | 'parametros' | 'auditoria' =
    viewParam === 'parametros' || viewParam === 'auditoria' ? viewParam : 'dashboard';
