...
function serializePersonalDeductions(value: PersonalDeductionsOutput) {
  return {
    ...
    deduccionEspecialDoceavaParte: decimalToNumber(value.deduccionEspecialDoceavaParte),
...
export function serializeTaxCalculationResult(result: TaxCalculationResult) {
  return {
    ...
    anticiposCanceladosIdcb: decimalToNumber(result.anticiposCanceladosIdcb),
    anticiposCanceladosEfectivo: decimalToNumber(result.anticiposCanceladosEfectivo),
    anticiposCanceladosMisFacilidades: decimalToNumber(result.anticiposCanceladosMisFacilidades),
    computoIdcb: decimalToNumber(result.computoIdcb),
    computoCombustibles: decimalToNumber(result.computoCombustibles),
    saldoTrasladableIdcb: decimalToNumber(result.saldoTrasladableIdcb),
    anticiposSiguientePeriodo: result.anticiposSiguientePeriodo.map(decimalToNumber),
    impuestoProyectadoAnticipos: decimalToNumber(result.impuestoProyectadoAnticipos),
    ...
    quebrantoTrasladable: decimalToNumber(result.quebrantoTrasladable),
...
export function hydrateTaxReturnPreviewResult(value: ReturnType<typeof serializeTaxCalculationResult>): TaxCalculationResult {
  return {
    ...
    deduccionesPersonales: {
      ...
      deduccionEspecialDoceavaParte: numberToDecimal(value.deduccionesPersonales.deduccionEspecialDoceavaParte),
    ...
    anticiposCanceladosIdcb: numberToDecimal(value.anticiposCanceladosIdcb),
    anticiposCanceladosEfectivo: numberToDecimal(value.anticiposCanceladosEfectivo),
    anticiposCanceladosMisFacilidades: numberToDecimal(value.anticiposCanceladosMisFacilidades),
    computoIdcb: numberToDecimal(value.computoIdcb),
    computoCombustibles: numberToDecimal(value.computoCombustibles),
    saldoTrasladableIdcb: numberToDecimal(value.saldoTrasladableIdcb),
    anticiposSiguientePeriodo: value.anticiposSiguientePeriodo.map(numberToDecimal),
    impuestoProyectadoAnticipos: numberToDecimal(value.impuestoProyectadoAnticipos),
    ...
    quebrantoTrasladable: numberToDecimal(value.quebrantoTrasladable),
