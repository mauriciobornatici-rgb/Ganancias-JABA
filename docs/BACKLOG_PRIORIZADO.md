...
- Punto 3 - Participacion en sociedades: **Siguiente**. Se cargan % de participacion y resultado total; la app calcula el atribuido y queda editable (verificacion cruzada).
